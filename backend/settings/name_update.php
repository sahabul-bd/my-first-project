                    ...
                    <div class="card-body">
                        <form action="../settings/manage_setting.php"  method="POST">
                            <div class="example-content">
                                ...
                                <input type="text" name="new_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                             ...
                             <button type="submit" name="update_btn" class="btn btn-primary m-r-xs mt-3"><i class="material-icons">add</i>Add</button>
