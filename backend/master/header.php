    ...
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                ...
                <a href="index.html" class="logo-icon"><span class="logo-text"></span></a>
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <?php if ($user['image'] == "defult.jpg") : ?>
                        <img style="height: 100px; width:100px; border-radius:50%" class="img" src="../../Public/default/<?=$user['image']?>">
                        <?php else : ?>
                        <img style="height: 100px; width:100px; border-radius:50%"  src="../../Public/upload/profile<?= $user['image'] ?>?>">
                        <?php endif;  ?>
                        <span class="activity-indicator"></span>
                        <h4 class="user-info-text"> <?= $_SESSION["author_name"] ?>  <br><span class="user-state-info">On a call</span></h4>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="../settings/name_update.php">Name Upddate</a>
                            </li>
                            <li>
                                <a href="../settings/email_update.php">Email Update</a>
                            </li>
                            <li>
                                <a href="../settings/password_update.php">Password Update</a>
                            </li>
                            <li>
                                <a href="../settings/profile_update.php">Image Update</a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li class="sidebar-title">
